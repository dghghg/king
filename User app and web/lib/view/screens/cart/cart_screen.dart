                      ...
                      child: CustomButton(
                        ...
                        onPressed: () {
                          if(_itemPrice < Provider.of<SplashProvider>(context, listen: false).configModel.minimumOrderValue) {
                            showCustomSnackBar('القيمه الادنى للاوردر ${PriceConverter.convertPrice(context, Provider.of<SplashProvider>(context, listen: false).configModel
                                .minimumOrderValue)}, قيمت اوردرك ${PriceConverter.convertPrice(context, _itemPrice)} فى الحقيبه, من فضلك اضف شيئأ اخر.', context,isError: true);
                          } else {
